...
All data in the mopidy is managed in a central repository, **GitHub**, that is accessible to all system components or subsystems.

**Esta parte n sei se esta correta**
O repositório é usado de forma passiva, visto que as requests feitas pelas componentes sao aceites de forma passiva, só tem de passar os testes.
